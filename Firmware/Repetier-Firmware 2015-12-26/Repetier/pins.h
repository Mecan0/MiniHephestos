...
#define ORIG_X_STEP_PIN     54//37
#define ORIG_X_DIR_PIN      55//48
#define ORIG_X_MIN_PIN      3//12
#define ORIG_X_MAX_PIN      79//24
#define ORIG_X_ENABLE_PIN   38//29
#define X_MS1_PIN      40
#define X_MS2_PIN      41

#define ORIG_Y_STEP_PIN     60//36
#define ORIG_Y_DIR_PIN      61//49
#define ORIG_Y_MIN_PIN      14//11
#define ORIG_Y_MAX_PIN      15//23
#define ORIG_Y_ENABLE_PIN   56//28
#define Y_MS1_PIN      69
#define Y_MS2_PIN      39

#define ORIG_Z_STEP_PIN     46//35
#define ORIG_Z_DIR_PIN      48//47
#define ORIG_Z_MIN_PIN      18//10
#define ORIG_Z_MAX_PIN      19//30
#define ORIG_Z_ENABLE_PIN   77//27
#define Z_MS1_PIN      68
#define Z_MS2_PIN      67

#define HEATER_0_PIN   9//9
#define TEMP_0_PIN     13//0

#define HEATER_1_PIN   10//3
#define TEMP_1_PIN     14//2

#define HEATER_2_PIN   8//7
#define TEMP_2_PIN     15//1

#define TEMP_3_PIN     8//7

#define ORIG_E0_STEP_PIN    26//34
#define ORIG_E0_DIR_PIN     28//43
#define ORIG_E0_ENABLE_PIN  24//26
#define E0_MS1_PIN     65
#define E0_MS2_PIN     66

#define ORIG_E1_STEP_PIN    36//33
#define ORIG_E1_DIR_PIN     34//42
#define ORIG_E1_ENABLE_PIN  30//25
#define E1_MS1_PIN     63
#define E1_MS2_PIN     64

#define DIGIPOTSS_PIN  22//38
#define DIGIPOT_CHANNELS {4,5,3,0,1} // X Y Z E0 E1 digipot channels to stepper driver mapping

#define SDPOWER        -1
#define SDSS           53
#define LED_PIN        13//13
#define ORIG_FAN_PIN        12//8
#define ORIG_FAN2_PIN    7//6
#define ORIG_FAN3_PIN    11//2
#define ORIG_PS_ON_PIN      81//4
#define SUICIDE_PIN    41//-1  //PIN that has to be turned on right after start, to keep power flowing.
